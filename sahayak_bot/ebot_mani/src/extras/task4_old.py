...
arm_group = moveit_commander.MoveGroupCommander("arm")y
...
# Arguments:- 6D Pose of the location (position)
...
def move_arm(pos_x, pos_y, pos_z, gripper_v):
    ...
    pose_target.position.z = 0.93 #pos_z
...
if __name__ == '__main__':
    ...
    Dict = {1:{'pos': [trans_coke[0], trans_coke[1], trans_coke[2]], 'gripper_v': 0.25}, 
            2:{'pos': [trans_battery[0], trans_battery[1], trans_battery[2]], 'gripper_v': 0.3},  
            3:{'pos': [trans_glue[0], trans_glue[1], trans_glue[2]], 'gripper_v': 0.25}} 
