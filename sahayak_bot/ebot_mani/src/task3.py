...
def move_arm(pos_x, pos_y, pos_z, or_x, or_y, or_z, or_w, gripper_v):
...
if __name__ == '__main__':
    ...
    Dict = {1:{'pos': [0.57234, -0.01541, 0.791986] , 'orient': [-0.428910594342, -0.903346049818, 0.000156570721622, 0.00126167521046], 'gripper_v': 0.25}, 
            2:{'pos': [0.457220879487, 0.223384328948, 0.800] , 'orient': [-0.304629451702, 0.952457338809, 0.0048572947131, 0.00152367737356] , 'gripper_v': 0.3},  
            3:{'pos': [0.562725274795, -0.240828684149, 0.85799] , 'orient': [0.0524953115323, 0.998612931696, -0.0040510154357, 0.00021021377887] , 'gripper_v': 0.25}} 

    for i in range(1,4):
        move_arm(Dict[i]['pos'][0], Dict[i]['pos'][1], Dict[i]['pos'][2], Dict[i]['orient'][0], Dict[i]['orient'][1], Dict[i]['orient'][2], Dict[i]['orient'][3], Dict[i]['gripper_v'])
